...
public class PaintingMapper {
    ...
    public PaintingMapper(SimpleAuthorRepository authorRepository) {
    ...
    public PaintingReadDTO toReadDTO(Painting painting) {
        ...
        String fetchedAuthorName = null;
        if (painting.getAuthorID() != null) {
            fetchedAuthorName = authorRepository.findById(painting.getAuthorID())
                    .map(SimpleAuthor::getName)
